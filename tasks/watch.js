...
// data changes
watch.watch('./src/?(*.json|*.md)', {ignored: /[\/\\]\./}).on('all', function(event, path) {
...
watch.watch('./src/*.mustache', {ignored: /[\/\\]\./}).on('all', function(event, path) {
...
watch.watch('./src/*.less', {ignored: /[\/\\]\./}).on('all', function(event, path) {
...
watch.watch('./src/images/*.*', {ignored: /[\/\\]\./}).on('all', function(event, path) {
